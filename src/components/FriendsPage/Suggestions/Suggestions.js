        ...
        <div className="row">
          <div className="col-xl-12">
            ...
            <div className="row pe-2 ps-2">
              <div className="col-md-3 col-sm-4 ps-2 pe-2">
                <div className="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                  <div className="card-body d-block w-100 pe-3 ps-3 pb-4 text-center">
                    ...
                    <a
                      href="#"
                      className="mt-0 btn pt-2 pb-2 pe-3 ps-3 lh-24 me-1 ls-3 d-inline-block rounded-xl bg-success font-xssss fw-500 ls-lg text-white"
                    >
                      ADD FRIEND
                      <HiPlus className="font-xs me-2 text-white" />
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-3 col-sm-4 ps-2 pe-2">
                <div className="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 mt-0">
                  <div className="card-body d-block w-100 pe-3 ps-3 pb-4 text-center">
                    <figure className="avatar me-auto ms-auto mb-0 position-relative w65 z-index-1">
                      <img
                        src={img}
